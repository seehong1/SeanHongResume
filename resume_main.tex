...
\textbf{\large Sandisk Technologies} \text{\footnotesize (Formerly Western Digital Corporation)}\vspace{3mm} \hfill Milpitas, CA\\\hspace*{0mm}\textbf{Senior SSD Validation Engineer}  \hfill \text{Apr 2024 - Present}
 ...
 \itemsep -0.5em \vspace{-0.5em}
   ...
   \item Developed validation plan for a new SSD data placement, improving random write
performance by 20\%
...
temperatures
 ...
 \end{itemize}
\vspace{2mm}
\hspace*{0mm}\textbf{Junior SSD Validation Engineer}  \hfill \text{Jan 2021 - Mar 2024}
 \begin{itemize}[left=0em]
 \itemsep -0.5em \vspace{-0.5em}
